package com.softlab.circleprogresslib;

/**
 * Created by olehsalamakha on 9/3/17.
 */
...
public class CircleProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mMainColor = ta.getColor(R.styleable.CircleProgress_round_progres_main_color, context.getResources().getColor(R.color.colorDefault));
        mIndicatorColor = ta.getColor(R.styleable.CircleProgress_round_progress_indicator_color, context.getResources().getColor(R.color.colorDefault));
